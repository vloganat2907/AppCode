...
public class BrowserStacks {
  ...
  public static void main(String[] args) throws MalformedURLException, InterruptedException {
      ...
      caps.setCapability("browserstack.user", "vignesh_zLZKBx");
      caps.setCapability("browserstack.key", "xgRMwbcqsQ6dx4bwzC1o");
      
      // Set URL of the application under test
      caps.setCapability("app", "bs://7a46a67452b09d6d1dccded877daabad1482e2a3");
      ...
      //Set Other Capabilities for Reset and Access Permission
